...
def nn_with_layers_api(
    ...
    X_test -- tensorbroad_pb_android input data, shape: number of examples x number of features.
    Y_test -- tensorbroad_pb_android label vector, shape: number of example.
    ...
    Returns:
    Print both training and tensorbroad_pb_android accuracy.
    ...
    with tf.Session(graph=g) as sess:
        ...
        # Compute the probabilities and predictions of both train & tensorbroad_pb_android data
        ...
        print("The tensorbroad_pb_android accuracy rate is: {:.2f}%.".format(test_accuracy))
